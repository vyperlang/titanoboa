import random
import string
from typing import Any, Callable, Iterable, Optional, Union, TypeAlias
...
@_exclude_filter
def _address_strategy(length: Optional[int] = 100, env: Optional[EnvType] = None) -> SearchStrategy:
    ...
    env_accounts = (
            {obj.address for obj in env._code_registry.values()}
    )
